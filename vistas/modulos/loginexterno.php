              ...
              <div class="card card-plain">
                ...
                <div class="card-body">
                  <form action="" method="POST">
                    ...
                    <div class="mb-3">
                        <input type="text" name="nombre" class="form-control form-control-lg" placeholder="Nombre Completo" aria-label="Email" autocomplete="off" required>
                      </div>

                      <div class="mb-3">
                        <input type="email" name="email3" class="form-control form-control-lg" placeholder="Correo" aria-label="Email" autocomplete="off" required>
                      </div>

                      <div class="mb-3">
                        <input type="text" name="centrotrabajo" class="form-control form-control-lg" placeholder="Centro de Trabajo" aria-label="Email" autocomplete="off" required>
                      </div>         
